  ...
  return (
    <div className='flex h-full lg:w-1/2 justify-self-center w-full bg-gray-500 border-[5px] p-5 text-white flex-col'>
        <div className='flex flex-row h-10 w-full'>
            <input type="text" placeholder='wpisz zadanie' className='w-3/4 rounded-l-md p-3 text-black text-lg outline-none'/>
            <button className='w-1/4 bg-slate-800 rounded-r-md hover:bg-slate-900'>Potwierdź</button>
        </div>
